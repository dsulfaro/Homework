...
View.prototype.exercise3 = function () {
  ...
  //your code here!
  $('body').append('<h1 style="margin-left: 800px">i love jquery</h1>');
};
...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  $('.square:nth-child(even)').append('<p>Dan</p>');
};
...
View.prototype.exercise6 = function () {
  ...
  //your code here!
  $('.square').each(function(i, s){
    $(s).css("background-color", window._randomColorString());
  });
};
